...
export function PromoBannerTile({ banner, sizes }: PromoBannerTileProps) {
  return (
    <Link
      ...
      className="relative block w-full min-w-0 overflow-hidden rounded-xl bg-neutral-100 outline-none ring-offset-2 transition hover:opacity-95 focus-visible:ring-2 focus-visible:ring-primary/40 sm:rounded-2xl [height:var(--promo-banner-height-mobile)] sm:[height:var(--promo-banner-height)]"
    >
      <Image
        src={banner.imageUrl}
        alt={banner.title}
