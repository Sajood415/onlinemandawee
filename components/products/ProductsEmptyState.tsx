...
export function ProductsEmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-3xl border border-dashed border-neutral-300 bg-white px-6 py-16 text-center shadow-[0_8px_30px_rgba(15,52,96,0.06)] sm:py-20">
      <div className="relative mb-6">
        <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-secondary/8 text-secondary">
      ...
      <h3 className="text-xl font-bold tracking-tight text-secondary sm:text-2xl">
        {title}
      </h3>
