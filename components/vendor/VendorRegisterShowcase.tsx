              ...
              <div className="relative flex h-full flex-col justify-center px-4 py-10 sm:px-7 lg:px-10">
                ...
                <div className="mt-6 flex flex-wrap items-center gap-3">
                  <Link
                    ...
                    className="inline-flex min-h-11 items-center justify-center rounded-lg bg-white px-5 py-2.5 text-sm font-semibold text-secondary shadow-sm transition hover:bg-neutral-100"
                  >
                    {t("startButton")}
                  </Link>
                  <a
