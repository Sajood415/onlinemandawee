...
export const headerCopy: Record<SupportedLocale, HeaderCopy> = {
  en: {
    ...
    megaBrowseMandawee: "Departments",
    megaBrowseVendors: "Shop by vendors",
  ...
  ps: {
    ...
    megaBrowseMandawee: "څانګې",
    megaBrowseVendors: "له پلورونکو څخه پیرود",
  ...
  "fa-AF": {
    ...
    megaBrowseMandawee: "بخش‌ها",
    megaBrowseVendors: "خرید از فروشندگان",
