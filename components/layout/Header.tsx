        ...
        <div className="mx-auto max-w-7xl px-4 py-2 sm:py-3">
          <div className="flex items-center justify-between gap-4 lg:gap-8">
            ...
            <form
              ...
              className="hidden lg:flex flex-1 items-center gap-3 bg-white hover:bg-gray-50 focus-within:bg-white focus-within:ring-2 focus-within:ring-primary/20 px-2 pl-5 rounded-full h-12 border border-gray-200 transition-all duration-300 group max-w-2xl shadow-sm"
            >
              <Search
